...
silenced_neurons = ic.meta[ic.meta['super_class'].isin(['sensory', 'ascending_sensory'])].neuron_id
...
for seed_category in seed_categories:
	...
	influence_df.to_csv(f"Influence/{seed_category}_influence.csv", index=False)

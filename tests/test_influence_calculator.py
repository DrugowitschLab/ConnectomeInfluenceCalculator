...
into calculate_influence, and the InfluenceCalculator.adjust_influence
@staticmethod itself.  PETSc/SLEPc-dependent tests use
pytest.importorskip so the suite remains runnable in environments
